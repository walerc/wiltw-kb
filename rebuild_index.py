...
#wiltw-panel, #futures-panel, #ta-panel, #qa-panel, #trend-panel, #pattern-panel, #channel-panel { display: none; }
#wiltw-panel.active, #futures-panel.active, #ta-panel.active, #qa-panel.active, #trend-panel.active, #pattern-panel.active, #channel-panel.active { display: block; }
...
function switchTab(tab){
  ...
  document.querySelectorAll('#wiltw-panel,#futures-panel,#ta-panel,#qa-panel,#trend-panel,#channel-panel,#pattern-panel').forEach(p=>p.classList.remove('active'));
  var idx=tab==='wiltw'?0:tab==='futures'?1:tab==='ta'?2:tab==='qa'?3:tab==='trend'?4:tab==='channel'?5:6;
